...
# choose a name for the web user 
SITEUSER='webuser'

# github repo from where the source code needs to be copied
GIT_REPO_URL='https://github.com/my-name/my-application.git'
REPONAME="my-application" # MUST MATCH WITH GIT REPO NAME
...
apt-get install --assume-yes --quiet php7.2-mbstring php-xml php-zip >>/dev/null
cd /root/
php -r "copy('https://getcomposer.org/installer', '/root/composer-setup.php');"
php -r "if (hash_file('SHA384', '/root/composer-setup.php') === '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5') { echo 'Installer verified'; } else { echo 'Installer corrupt'; unlink('composer-setup.php'); } echo PHP_EOL;"
...
apt --assume-yes --quiet install redis-server
...
#sudo -H -u ${SITEUSER} bash -c 'composer require ext-phpiredis'
# If_Error_Exit "Failed to install redis."
